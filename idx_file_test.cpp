...
int main() {
  ...
  fmt::print("data type: {:#x}, dimensions: {}\n", static_cast<int8_t>(t10k_images.getDataType()), t10k_images.getIdxDimension());
...
//  int n = dim_size[0];
  ...
  RuNet::Tensor t10k_images_tensor = t10k_images.read_data(n, c, h, w);
  cv::Mat t10k_first_image = t10k_images_tensor.convert_to_opencv_image(CV_8UC1);
  std::cout << t10k_first_image << std::endl;
  cv::imwrite("t10k_first_image.png", t10k_first_image);
